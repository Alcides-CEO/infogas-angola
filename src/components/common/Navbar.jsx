    ...
    <nav className={`navbar ${scrolled ? 'navbar--scrolled' : ''}`}>
      <div className="navbar__inner">
        ...
        <Link to="/home" className="navbar__logo">
          ...
          <span className="navbar__logo-name">Infogás</span>
        ...
        <div className={`navbar__links ${menuOpen ? 'navbar__links--open' : ''}`}>
          ...
          <a href="#contactos" className="navbar__link">Contactos</a>
          <Link to="/reservas" className="navbar__link">Reservas</Link>
          <Link to="/vendor/login" className="navbar__link navbar__link--vendor">Sou Vendedor</Link>
        </div>
